...
class MailingTemplateConfigurationConfigTest extends TestCase
{
    /**
     * @var MailingTemplateConfigurationConfig
     */
    private $subject;
    ...
    {
        $this->subject = new MailingTemplateConfigurationConfig();
    }
