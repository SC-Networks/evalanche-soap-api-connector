...
use Scn\EvalancheSoapStruct\Struct\LeadPageTemplate\LeadpageTemplateAllowedTemplates;
use Scn\EvalancheSoapStruct\Struct\StructInterface;
use Scn\HydratorPropertyValues\Property\IntegerValue;

class LeadpageTemplateAllowedTemplatesConfig implements HydratorConfigInterface
{
    public function getObject(): StructInterface
    {
        return new LeadpageTemplateAllowedTemplates();
    }
